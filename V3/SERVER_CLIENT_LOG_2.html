...
<head>
  <!-- SchemaSpy rev 590 -->
  <title>SchemaSpy - Table sem5.dbo.SERVER_CLIENT_LOG_2</title>
  <link rel=stylesheet href='../schemaSpy.css' type='text/css'>
  <meta HTTP-EQUIV='Content-Type' CONTENT='text/html; charset=ISO-8859-1'>
  <SCRIPT LANGUAGE='JavaScript' TYPE='text/javascript' SRC='../jquery.js'></SCRIPT>
  <SCRIPT LANGUAGE='JavaScript' TYPE='text/javascript' SRC='../schemaSpy.js'></SCRIPT>
  <SCRIPT LANGUAGE='JavaScript' TYPE='text/javascript'>
    table='SERVER_CLIENT_LOG_2';
  </SCRIPT>
</head>
<body>
...
<table width='100%' border='0' cellpadding='0'>
 <tr>
  <td class='heading' valign='middle'><span class='header'>Table <span title='Database'>sem5</span>.<span title='Schema'>dbo</span>.<span title='Table'>SERVER_CLIENT_LOG_2</span></span><div style='padding: 0px 4px;'>Keeps client activities that occur in server.</div><p>
</td>
...
<tr class='even'>
 ...
 <td class='detail'></td>
 <td class='detail'> </td>
 <td class='comment detail'>The unique ID of the client activity event:<br />    1 = Registration succeeded.<br />    2 = Registration failed.<br />    3 = The client reconnected.<br />    4 = The client disconnected.<br />    5 = Downloaded policy. <br />    6 = Downloaded intrusion prevention policy.<br />    7 = Downloaded sylink.xml. <br />    8 = Downloaded AutoUpgrade file. <br />    9 = The server received the log.<br />    10 = The log processing failed.<br />    11 = The server received learned application information. <br />    12 = The server received client information. <br />    13 = Client information processing failed. <br />    14 = A hardware identity change occurred. <br />    15 = Downloaded a file fingerprint list. <br />    20 = Downloaded the content package. <br />    22 = Downloaded the command.</td>
</tr>
<tr class='odd'>
...
<tr class='even'>
 ...
 <td class='detail'></td>
 <td class='detail'> </td>
 <td class='comment detail'>The computer name of the client.</td>
</tr>
<tr class='odd'>
 ...
 <td class='detail'></td>
 <td class='detail'> </td>
 <td class='comment detail'>The logon user name of the client.</td>
</tr>
<tr class='even'>
 ...
 <td class='detail'></td>
 <td class='detail'> </td>
 <td class='comment detail'>The domain name of the client.</td>
</tr>
<tr class='odd'>
...
<tr class='odd'>
 ...
 <td class='detail'></td>
 <td class='detail'> </td>
 <td class='comment detail'>The log index's unique ID.</td>
</tr>
<tr class='even'>
...
<tbody>
 <tr>
  ...
  <td class='constraint' style='text-align:left;'>I_SERVER_CLIENT_LOG_2</td>
 </tr>
 <tr>
  <td class='indexedColumn'>CLIENT_ID</td>
  <td class='detail'>Performance</td>
  <td class='detail' style='text-align:left;'><span title='Ascending'>Asc</span></td>
  <td class='constraint' style='text-align:left;'>I_SERVER_CLIENT_LOG_2_CLIENT_ID</td>
 </tr>
 <tr>
  <td class='indexedColumn'>LOG_IDX</td>
  <td class='detail'>Performance</td>
  <td class='detail' style='text-align:left;'><span title='Ascending'>Asc</span></td>
  <td class='constraint' style='text-align:left;'>I_SERVER_CLIENT_LOG_2_LOG_IDX</td>
 </tr>
 <tr>
  <td class='indexedColumn'>TIME_STAMP</td>
  <td class='detail'>Performance</td>
  <td class='detail' style='text-align:left;'><span title='Ascending'>Asc</span></td>
  <td class='constraint' style='text-align:left;'>I_SERVER_CLIENT_LOG_2_TIME</td>
 </tr>
</table>
</div>
</div>
