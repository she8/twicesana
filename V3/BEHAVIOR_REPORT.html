...
<head>
  <!-- SchemaSpy rev 590 -->
  <title>SchemaSpy - Table sem5.dbo.BEHAVIOR_REPORT</title>
...
<table width='100%' border='0' cellpadding='0'>
 <tr>
  <td class='heading' valign='middle'><span class='header'>Table <span title='Database'>sem5</span>.<span title='Schema'>dbo</span>.<span title='Table'>BEHAVIOR_REPORT</span></span><div style='padding: 0px 4px;'>Keeps the administrator-defined filters for the Application Control log.</div><p>
</td>
...
<tbody valign='top'>
<tr class='odd'>
 <td class='detail'>BEHAVIORFILTER_IDX</td>
...
<tr class='even'>
 ...
 <td class='detail'></td>
 <td class='detail'> </td>
 <td class='comment detail'>The filter start date.</td>
</tr>
<tr class='odd'>
 ...
 <td class='detail'></td>
 <td class='detail'> </td>
 <td class='comment detail'>The filter end date.</td>
</tr>
<tr class='even'>
...
<tr class='odd'>
 <td class='primaryKey' title='Primary Key'>BEHAVIORTYPE</td>
 ...
 <td class='detail'></td>
 <td class='detail'> </td>
 <td class='comment detail'>1 = Application type, 2 =  Device Control type</td>
</tr>
<tr class='even'>
 ...
 <td class='detail'></td>
 <td class='detail'> </td>
 <td class='comment detail'>1 = Critical<br />5 = Major<br />9 = Minor<br />13 = Information</td>
</tr>
<tr class='odd'>
 ...
 <td class='detail'></td>
 <td class='detail'> </td>
 <td class='comment detail'>For Application Control<br />501 = Application Control Driver<br />502 = Application Control Rules<br />999 = Tamper Protection</td>
</tr>
<tr class='even'>
 ...
 <td class='detail'></td>
 <td class='detail'> </td>
 <td class='comment detail'>0 = Allow<br />1 = Block<br />2 = Ask<br />3 = Continue<br />4 = Terminate</td>
</tr>
<tr class='odd'>
...
<tr class='even'>
 <td class='detail'>CALLERPROCESSLIST</td>
 <td class='detail'>nvarchar</td>
 <td class='detail' align='right'>510</td>
 <td class='detail' align='center'></td>
 <td class='detail' align='center'></td>
 ...
 <td class='detail'></td>
 <td class='detail'> </td>
 <td class='comment detail'>Comma-separated, wild-carded process names by which to filter.</td>
</tr>
<tr class='odd'>
 ...
 <td class='detail'></td>
 <td class='detail'> </td>
 <td class='comment detail'>Comma-separated, wild-carded IP by which to filter.</td>
</tr>
<tr class='even'>
...
<tr class='odd'>
 ...
 <td class='detail'></td>
 <td class='detail'> </td>
 <td class='comment detail'>1 = Yes, 0 = No</td>
</tr>
<tr class='even'>
...
<tr class='even'>
 ...
 <td class='detail'></td>
 <td class='detail'> </td>
 <td class='comment detail'>The number of rows to show for pagination.</td>
</tr>
<tr class='odd'>
...
<tr class='odd'>
 <td class='detail'>FILE_UPDOWN</td>
 <td class='detail'>tinyint</td>
 <td class='detail' align='right'>1</td>
 <td class='detail' align='center'></td>
 <td class='detail' align='center'></td>
 ...
 <td class='detail'></td>
 <td class='detail'> </td>
 <td class='comment detail'>Greater than or less than.  Used for filtering in association with FILE_SIZE in this table.<br />     0 = Don't filter with this<br />     1 = Greater than<br />     2 = Less than</td>
</tr>
<tr class='even'>
 ...
 <td class='detail'></td>
 <td class='detail'> </td>
 <td class='comment detail'>Size of the file, in bytes, associated with the application control violation. Used for filtering.</td>
</tr>
</table>
...
<tbody>
 <tr>
  <td class='primaryKey'>USER_ID + FILTERNAME + BEHAVIORTYPE</td>
  ...
  <td class='constraint' style='text-align:left;'>PK_BEHAVIORREPORT</td>
 </tr>
</table>
</div>
</div>
