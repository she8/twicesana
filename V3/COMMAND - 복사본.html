...
<head>
  <!-- SchemaSpy rev 590 -->
  <title>SchemaSpy - Table sem5.dbo.COMMAND</title>
...
<table width='100%' border='0' cellpadding='0'>
 <tr>
  <td class='heading' valign='middle'><span class='header'>Table <span title='Database'>sem5</span>.<span title='Schema'>dbo</span>.<span title='Table'>COMMAND</span></span><div style='padding: 0px 4px;'>Keeps the Command status for agents.</div><p>
</td>
...
<tbody valign='top'>
<tr class='even'>
 <td class='primaryKey' title='Primary Key'>HARDWARE_KEY</td>
...
<tr class='odd'>
 <td class='primaryKey' title='Primary Key'>COMMAND_ID</td>
 <td class='detail'>char</td>
 <td class='detail' align='right'>32</td>
 <td class='detail' align='center'></td>
 <td class='detail' align='center'></td>
...
<tr class='even'>
 ...
 <td class='detail'></td>
 <td class='detail'> </td>
 <td class='comment detail'>The domain ID that was currently being administered when the command was created.</td>
</tr>
<tr class='odd'>
...
<tr class='even'>
 ...
 <td class='detail'></td>
 <td class='detail'> </td>
 <td class='comment detail'>The time that the command launched on the client (GMT).</td>
</tr>
<tr class='odd'>
 <td class='detail'>LAST_UPDATE_TIME</td>
 <td class='detail'>bigint</td>
 <td class='detail' align='right'>8</td>
 <td class='detail' align='center'></td>
 <td class='detail' align='center'></td>
 ...
 <td class='detail'></td>
 <td class='detail'> </td>
 <td class='comment detail'>The time that the client last reported its status (GMT).</td>
</tr>
<tr class='even'>
 ...
 <td class='detail'></td>
 <td class='detail'> </td>
 <td class='comment detail'>Command status: a numeric value corresponding to one of the following:<br />0 = INITIAL<br />1 = RECEIVED<br />2 = IN_PROGRESS<br />3 = COMPLETED<br />4 = REJECTED<br />5 = CANCELLED<br />6 = ERROR<br /><br />When first created, command status = INITIAL.  It indicates that the endpoint has not received it yet.<br /></td>
</tr>
<tr class='odd'>
...
<tr class='even'>
 <td class='detail'>SUB_STATE_DESC</td>
 ...
 <td class='detail'></td>
 <td class='detail'> </td>
 <td class='comment detail'>Command-specific extra information, such as number of files scanned, or error messages.</td>
</tr>
<tr class='odd'>
 <td class='detail'>ESTIMATED_DURATION</td>
 <td class='detail'>int</td>
 <td class='detail' align='right'>4</td>
 <td class='detail' align='center'></td>
 <td class='detail' align='center'></td>
 ...
 <td class='detail'></td>
 <td class='detail'> </td>
 <td class='comment detail'>Agent estimation of command duration in minutes. 0 = no estimate or negligible time.</td>
</tr>
<tr class='even'>
 ...
 <td class='detail'></td>
 <td class='detail'> </td>
 <td class='comment detail'>Progress (0-100%) of command, based on estimated duration.</td>
</tr>
<tr class='odd'>
 ...
 <td class='detail'></td>
 <td class='detail'> </td>
 <td class='comment detail'>The time on the server when the command is added into the system (GMT).</td>
</tr>
<tr class='even'>
...
<tr class='even'>
 <td class='detail'>BINARY_RESULTS_ID</td>
 <td class='detail'>char</td>
 <td class='detail' align='right'>32</td>
 <td class='detail' align='center' title='nullable'>&nbsp;&radic;&nbsp;</td>
 <td class='detail' align='center'></td>
