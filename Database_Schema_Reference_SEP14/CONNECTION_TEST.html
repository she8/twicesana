...
<head>
  <!-- SchemaSpy rev 590 -->
  <title>SchemaSpy - Table sem5.dbo.CONNECTION_TEST</title>
...
<table width='100%' border='0' cellpadding='0'>
 <tr>
  <td class='heading' valign='middle'><span class='header'>Table <span title='Database'>sem5</span>.<span title='Schema'>dbo</span>.<span title='Table'>CONNECTION_TEST</span></span><div style='padding: 0px 4px;'>For internal use. Indicates the state of the database connection.</div><p>
</td>
...
<tr class='even'>
 ...
 <td class='detail'></td>
 <td class='detail'> </td>
 <td class='comment detail'>Not specified.</td>
</tr>
</table>
