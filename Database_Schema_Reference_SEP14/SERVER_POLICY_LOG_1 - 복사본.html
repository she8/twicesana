...
<head>
  <!-- SchemaSpy rev 590 -->
  <title>SchemaSpy - Table sem5.dbo.SERVER_POLICY_LOG_1</title>
  <link rel=stylesheet href='../schemaSpy.css' type='text/css'>
  <meta HTTP-EQUIV='Content-Type' CONTENT='text/html; charset=ISO-8859-1'>
  <SCRIPT LANGUAGE='JavaScript' TYPE='text/javascript' SRC='../jquery.js'></SCRIPT>
  <SCRIPT LANGUAGE='JavaScript' TYPE='text/javascript' SRC='../schemaSpy.js'></SCRIPT>
  <SCRIPT LANGUAGE='JavaScript' TYPE='text/javascript'>
    table='SERVER_POLICY_LOG_1';
  </SCRIPT>
</head>
<body>
...
<table width='100%' border='0' cellpadding='0'>
 <tr>
  <td class='heading' valign='middle'><span class='header'>Table <span title='Database'>sem5</span>.<span title='Schema'>dbo</span>.<span title='Table'>SERVER_POLICY_LOG_1</span></span><div style='padding: 0px 4px;'>Keeps policy change activities that occur in server.</div><p>
</td>
...
<tr class='even'>
 ...
 <td class='detail'></td>
 <td class='detail'> </td>
 <td class='comment detail'>The GUID of the domain which was administered.</td>
</tr>
<tr class='odd'>
...
<tr class='even'>
 ...
 <td class='detail'></td>
 <td class='detail'> </td>
 <td class='comment detail'>The unique ID of the policy event:<br /> 0 = The policy was added.<br /> 1 = The policy was deleted. <br /> 2 = The policy was edited.<br /> 3 = Added a shared policy upon system installation.<br /> 4 = Add a shared policy upon a system upgrade.<br /> 5 = Add a shared policy upon domain creation.</td>
</tr>
<tr class='odd'>
...
<tbody>
 <tr>
  ...
  <td class='constraint' style='text-align:left;'>I_SERVER_POLICY_LOG_1</td>
 </tr>
 <tr>
  <td class='indexedColumn'>OBJECT_ID</td>
  <td class='detail'>Performance</td>
  <td class='detail' style='text-align:left;'><span title='Ascending'>Asc</span></td>
  <td class='constraint' style='text-align:left;'>I_SERVER_POLICY_LOG_1_OBJ</td>
 </tr>
 <tr>
  <td class='indexedColumn'>TIME_STAMP</td>
  <td class='detail'>Performance</td>
  <td class='detail' style='text-align:left;'><span title='Ascending'>Asc</span></td>
  <td class='constraint' style='text-align:left;'>I_SERVER_POLICY_LOG_1_TIME</td>
 </tr>
</table>
</div>
</div>
