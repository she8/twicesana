...
<head>
  <!-- SchemaSpy rev 590 -->
  <title>SchemaSpy - Table sem5.dbo.TASKSTATE</title>
...
<table width='100%' border='0' cellpadding='0'>
 <tr>
  <td class='heading' valign='middle'><span class='header'>Table <span title='Database'>sem5</span>.<span title='Schema'>dbo</span>.<span title='Table'>TASKSTATE</span></span><div style='padding: 0px 4px;'>For internal use only. Indicates whether a given process is still running or is hanging.</div><p>
</td>
...
<tr class='odd'>
 <td class='detail'>LASTUPDATETIME</td>
 <td class='detail'>bigint</td>
 <td class='detail' align='right'>8</td>
 <td class='detail' align='center'></td>
 <td class='detail' align='center'></td>
