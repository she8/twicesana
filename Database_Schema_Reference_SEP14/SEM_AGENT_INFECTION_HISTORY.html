...
<head>
  <!-- SchemaSpy rev 590 -->
  <title>SchemaSpy - Table sem5.dbo.SEM_AGENT_INFECTION_HISTORY</title>
  <link rel=stylesheet href='../schemaSpy.css' type='text/css'>
  <meta HTTP-EQUIV='Content-Type' CONTENT='text/html; charset=ISO-8859-1'>
  <SCRIPT LANGUAGE='JavaScript' TYPE='text/javascript' SRC='../jquery.js'></SCRIPT>
  <SCRIPT LANGUAGE='JavaScript' TYPE='text/javascript' SRC='../schemaSpy.js'></SCRIPT>
  <SCRIPT LANGUAGE='JavaScript' TYPE='text/javascript'>
    table='SEM_AGENT_INFECTION_HISTORY';
  </SCRIPT>
</head>
<body>
...
<table width='100%' border='0' cellpadding='0'>
 <tr>
  <td class='heading' valign='middle'><span class='header'>Table <span title='Database'>sem5</span>.<span title='Schema'>dbo</span>.<span title='Table'>SEM_AGENT_INFECTION_HISTORY</span></span><div style='padding: 0px 4px;'>Holds the infection history for an agent. This table has no primary key.</div><p>
</td>
...
<tr class='even'>
 ...
 <td class='detail'></td>
 <td class='detail'> </td>
 <td class='comment detail'>The unique key number for the reported infection.</td>
</tr>
<tr class='odd'>
 ...
 <td class='detail'></td>
 <td class='detail'> </td>
 <td class='comment detail'>The identity of the computer that reported the infection.</td>
</tr>
<tr class='even'>
 ...
 <td class='detail'></td>
 <td class='detail'> </td>
 <td class='comment detail'>The update serial number (USN) for the reported infection; used by replication.</td>
</tr>
<tr class='odd'>
 ...
 <td class='detail'></td>
 <td class='detail'> </td>
 <td class='comment detail'>The time stamp of the infection report.</td>
</tr>
<tr class='even'>
 ...
 <td class='detail'></td>
 <td class='detail'> </td>
 <td class='comment detail'>The infection's event ID.</td>
</tr>
<tr class='odd'>
 ...
 <td class='detail'></td>
 <td class='detail'> </td>
 <td class='comment detail'>Indicates a flag to mark the row for deletion (0 = not flagged, 1 = flagged).</td>
</tr>
<tr class='even'>
 ...
 <td class='detail'></td>
 <td class='detail'> </td>
 <td class='comment detail'>The date and time of the reported infection event.</td>
</tr>
</table>
...
<tbody>
 <tr>
  <td class='indexedColumn'>EVENT_TIME + EVENT_ID + COMPUTER_IDX</td>
  ...
  <td class='constraint' style='text-align:left;'>IX_SEM_AGENT_INFECTION_HISTORY</td>
 </tr>
</table>
</div>
</div>
