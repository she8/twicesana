...
<head>
  <!-- SchemaSpy rev 590 -->
  <title>SchemaSpy - Table sem5.dbo.GUIPARMS</title>
...
<table width='100%' border='0' cellpadding='0'>
 <tr>
  <td class='heading' valign='middle'><span class='header'>Table <span title='Database'>sem5</span>.<span title='Schema'>dbo</span>.<span title='Table'>GUIPARMS</span></span><div style='padding: 0px 4px;'>Keeps parameters used in the console GUI.</div><p>
</td>
...
<tbody valign='top'>
<tr class='odd'>
 <td class='primaryKey' title='Primary Key'>GUIPARMS_IDX</td>
...
<tbody>
 <tr>
  <td class='primaryKey'>GUIPARMS_IDX</td>
  <td class='detail'>Primary key</td>
  <td class='detail' style='text-align:left;'><span title='Ascending'>Asc</span></td>
  <td class='constraint' style='text-align:left;'>PK_GUIPARMS</td>
 </tr>
</table>
</div>
</div>
