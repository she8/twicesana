...
<head>
  <!-- SchemaSpy rev 590 -->
  <title>SchemaSpy - Table sem5.dbo.SCANREPORT</title>
...
<table width='100%' border='0' cellpadding='0'>
 <tr>
  <td class='heading' valign='middle'><span class='header'>Table <span title='Database'>sem5</span>.<span title='Schema'>dbo</span>.<span title='Table'>SCANREPORT</span></span><div style='padding: 0px 4px;'>Keeps the administrator-defined filters for the Scan log.</div><p>
</td>
...
<tbody valign='top'>
<tr class='odd'>
 <td class='detail'>SCANFILTER_IDX</td>
...
<tr class='even'>
 <td class='detail'>STARTTIMEFROM</td>
 ...
 <td class='detail'></td>
 <td class='detail'> </td>
 <td class='comment detail'>The start date and time.</td>
</tr>
<tr class='odd'>
 <td class='detail'>STARTTIMETO</td>
 <td class='detail'>datetime</td>
 <td class='detail' align='right'>16,3</td>
 <td class='detail' align='center'></td>
 <td class='detail' align='center'></td>
 ...
 <td class='detail'></td>
 <td class='detail'> </td>
 <td class='comment detail'>The end date and time.</td>
</tr>
<tr class='even'>
...
<tr class='odd'>
 ...
 <td class='detail'></td>
 <td class='detail'> </td>
 <td class='comment detail'>Length of the scan</td>
</tr>
<tr class='even'>
 <td class='detail'>FILESCANNED</td>
...
<tr class='odd'>
 ...
 <td class='detail'></td>
 <td class='detail'> </td>
 <td class='comment detail'>The number of risks that the scan found.</td>
</tr>
<tr class='even'>
 <td class='detail'>FILESINFECTED</td>
 <td class='detail'>bigint</td>
 <td class='detail' align='right'>8</td>
 <td class='detail' align='center'></td>
 <td class='detail' align='center'></td>
 ...
 <td class='detail'></td>
 <td class='detail'> </td>
 <td class='comment detail'>The number of files that the scan found.</td>
</tr>
<tr class='odd'>
 <td class='detail'>SCANSTARTMESSAGE</td>
 <td class='detail'>nvarchar</td>
 <td class='detail' align='right'>510</td>
 <td class='detail' align='center'></td>
 <td class='detail' align='center'></td>
 ...
 <td class='detail'></td>
 <td class='detail'> </td>
 <td class='comment detail'>The scan's description.</td>
</tr>
<tr class='even'>
 ...
 <td class='detail'></td>
 <td class='detail'> </td>
 <td class='comment detail'>Scan status, as a hard-coded English key:  Completed, Canceled, Started; % means no filter (all)</td>
</tr>
<tr class='odd'>
 ...
 <td class='detail'></td>
 <td class='detail'> </td>
 <td class='comment detail'>Comma-separated, wild-carded list of server groups by which to filter.</td>
</tr>
<tr class='even'>
...
<tr class='odd'>
 ...
 <td class='detail'></td>
 <td class='detail'> </td>
 <td class='comment detail'>Comma-separated, wild-carded list of parent servers by which to filter.</td>
</tr>
<tr class='even'>
...
<tr class='odd'>
 <td class='detail'>LASTCOLUMN</td>
 <td class='detail'>varchar</td>
 <td class='detail' align='right'>32</td>
 <td class='detail' align='center'></td>
 <td class='detail' align='center'></td>
 <td class='detail' align='right'>('SERVERGROUP')</td>
 <td class='detail'></td>
 <td class='detail'> </td>
...
<tr class='even'>
 ...
 <td class='detail' align='center'></td>
 <td class='detail' align='center'></td>
 <td class='detail' align='right'>('STARTDATETIME')</td>
 <td class='detail'></td>
 <td class='detail'> </td>
 <td class='comment detail'>I.Computer' <br />'P.Parentserver' <br />'G.Clientgroup'  <br />'C.Clientuser' <br />'S.Servergroup' <br />'SC.Startdatetime'<br />'SC.Duration' <br />'SC.Totalfiles' (total files scanned)<br />'SC.Threats' <br />'SC.Infected' (total files infected)</td>
</tr>
<tr class='odd'>
...
<tbody>
 <tr>
  ...
  <td class='constraint' style='text-align:left;'>PK_SCANREPORT</td>
 </tr>
</table>
</div>
</div>
