...
<head>
  <!-- SchemaSpy rev 590 -->
  <title>SchemaSpy - Table sem5.dbo.NOTIFICATIONHISTORY</title>
...
<table width='100%' border='0' cellpadding='0'>
 <tr>
  <td class='heading' valign='middle'><span class='header'>Table <span title='Database'>sem5</span>.<span title='Schema'>dbo</span>.<span title='Table'>NOTIFICATIONHISTORY</span></span></td>
...
<tbody>
 <tr>
  ...
  <td class='constraint' style='text-align:left;'>PK_NOTIFICATIONHISTORY</td>
 </tr>
</table>
</div>
</div>
