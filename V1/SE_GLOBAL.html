...
<head>
  <!-- SchemaSpy rev 590 -->
  <title>SchemaSpy - Table sem5.dbo.SE_GLOBAL</title>
...
<table width='100%' border='0' cellpadding='0'>
 <tr>
  <td class='heading' valign='middle'><span class='header'>Table <span title='Database'>sem5</span>.<span title='Schema'>dbo</span>.<span title='Table'>SE_GLOBAL</span></span><div style='padding: 0px 4px;'>Keeps system sequence number.</div><p>
</td>
...
<tr class='odd'>
 ...
 <td class='detail'></td>
 <td class='detail'> </td>
 <td class='comment detail'>The latest USN on the site.</td>
</tr>
</table>
