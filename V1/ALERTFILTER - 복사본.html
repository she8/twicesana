...
<head>
  <!-- SchemaSpy rev 590 -->
  <title>SchemaSpy - Table sem5.dbo.ALERTFILTER</title>
...
<table width='100%' border='0' cellpadding='0'>
 <tr>
  <td class='heading' valign='middle'><span class='header'>Table <span title='Database'>sem5</span>.<span title='Schema'>dbo</span>.<span title='Table'>ALERTFILTER</span></span><div style='padding: 0px 4px;'>The administrator-defined filters for the notification log.</div><p>
</td>
...
<tbody valign='top'>
<tr class='even'>
 <td class='detail'>ALERTFILTER_IDX</td>
...
<tr class='odd'>
 ...
 <td class='detail'></td>
 <td class='detail'> </td>
 <td class='comment detail'>User ID</td>
</tr>
<tr class='even'>
 ...
 <td class='detail'></td>
 <td class='detail'> </td>
 <td class='comment detail'>The user-specified name of the filter.</td>
</tr>
<tr class='odd'>
...
<tr class='odd'>
 ...
 <td class='detail'></td>
 <td class='detail'> </td>
 <td class='comment detail'>0 = past week <br />1 = past month  <br />2 = past three months  <br />3 = past year   <br />4 = past 24 hours   <br />5 = current month</td>
</tr>
<tr class='even'>
 <td class='detail'>FILTERACKNOWLEDGED</td>
 <td class='detail'>nvarchar</td>
 <td class='detail' align='right'>510</td>
 <td class='detail' align='center'></td>
 <td class='detail' align='center'></td>
 ...
 <td class='detail'></td>
 <td class='detail'> </td>
 <td class='comment detail'>1 = Acknowledged<br />0 = Unacknowledged</td>
</tr>
<tr class='odd'>
 <td class='detail'>FILTERSUBJECT</td>
 <td class='detail'>nvarchar</td>
 <td class='detail' align='right'>510</td>
 <td class='detail' align='center'></td>
 <td class='detail' align='center'></td>
 ...
 <td class='detail'></td>
 <td class='detail'> </td>
 <td class='comment detail'>AF = Authentication failure<br />CL = The client list changed<br />CS = Client security alert<br />ED = Enforcer down<br />WL = Forced or commercial application detected<br />LA = New learned application<br />NV = New risk detected<br />NS = New software package<br />VO = Virus outbreak<br />DF = Server health<br />1V = Single risk event<br />SE = System event<br />UM = Unmanaged computer <br />ID = Virus definitions are out-of-date</td>
</tr>
<tr class='even'>
 <td class='detail'>FILTERCREATEDBY</td>
 <td class='detail'>nvarchar</td>
 <td class='detail' align='right'>510</td>
 <td class='detail' align='center'></td>
 <td class='detail' align='center'></td>
 ...
 <td class='detail'></td>
 <td class='detail'> </td>
 <td class='comment detail'>The GUID of the administrator who created any alert filters.</td>
</tr>
<tr class='odd'>
...
<tr class='odd'>
 <td class='detail'>NOTIFICATIONNAME</td>
 <td class='detail'>nvarchar</td>
 <td class='detail' align='right'>510</td>
 <td class='detail' align='center'></td>
 <td class='detail' align='center'></td>
 ...
 <td class='detail'></td>
 <td class='detail'> </td>
 <td class='comment detail'>The name of the selected notification condition.</td>
</tr>
<tr class='even'>
...
<p title='25 columns'>Analyzed at Wed Apr 12 14:15 PDT 2017<p/>
</td></tr></table>
<div class='indent'>
<b>Indexes:</b>
...
<tbody>
 <tr>
  ...
  <td class='constraint' style='text-align:left;'>PK_ALERTFILTER</td>
 </tr>
</table>
</div>
</div>
