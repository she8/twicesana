...
<head>
  <!-- SchemaSpy rev 590 -->
  <title>SchemaSpy - Table sem5.dbo.PROCESS_STATE</title>
...
<table width='100%' border='0' cellpadding='0'>
 <tr>
  <td class='heading' valign='middle'><span class='header'>Table <span title='Database'>sem5</span>.<span title='Schema'>dbo</span>.<span title='Table'>PROCESS_STATE</span></span><div style='padding: 0px 4px;'>Tracks whether Symantec Endpoint Protection Manager processes are locked or unlocked.</div><p>
</td>
...
<tr class='even'>
 ...
 <td class='detail'></td>
 <td class='detail'> </td>
 <td class='comment detail'>"PROCESS_STATE" is set for processes synchronization.</td>
</tr>
<tr class='odd'>
 ...
 <td class='detail'></td>
 <td class='detail'> </td>
 <td class='comment detail'>Virus definition <br />PROCESS_STATE_NA = -1<br />PROCESS_STATE_UNLOCKED = 0<br />PROCESS_STATE_LOCKED = 1</td>
</tr>
<tr class='even'>
 ...
 <td class='detail'></td>
 <td class='detail'> </td>
 <td class='comment detail'>The time on the server when the event is inserted/updated iinto the system (GMT).</td>
</tr>
<tr class='odd'>
 <td class='detail'>UPDATE_OWNER</td>
 <td class='detail'>varchar</td>
 ...
 <td class='detail'></td>
 <td class='detail'> </td>
 <td class='comment detail'>The server ID and the process name.</td>
</tr>
</table>
...
<tbody>
 <tr>
  ...
  <td class='constraint' style='text-align:left;'>PK_PROCESS_STATE</td>
 </tr>
</table>
</div>
</div>
