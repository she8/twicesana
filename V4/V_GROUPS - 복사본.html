...
<head>
  <!-- SchemaSpy rev 590 -->
  <title>SchemaSpy - Table sem5.dbo.V_GROUPS</title>
...
<table width='100%' border='0' cellpadding='0'>
 <tr>
  <td class='heading' valign='middle'><span class='header'>Table <span title='Database'>sem5</span>.<span title='Schema'>dbo</span>.<span title='Table'>V_GROUPS</span></span><div style='padding: 0px 4px;'>Query the groups' information.</div><p>
</td>
