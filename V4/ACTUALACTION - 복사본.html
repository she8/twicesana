...
<head>
  <!-- SchemaSpy rev 590 -->
  <title>SchemaSpy - Table sem5.dbo.ACTUALACTION</title>
...
<table width='100%' border='0' cellpadding='0'>
 <tr>
  <td class='heading' valign='middle'><span class='header'>Table <span title='Database'>sem5</span>.<span title='Schema'>dbo</span>.<span title='Table'>ACTUALACTION</span></span><div style='padding: 0px 4px;'>Lists and defines the meanings of the antivirus remediation action integers.  The action integers represent the actions that the antivirus engine can take when dealing with a threat.</div><p>
</td>
...
<tbody valign='top'>
<tr class='even'>
 <td class='primaryKey' title='Primary Key'>ACTUALACTION_IDX</td>
...
<tbody>
 <tr>
  <td class='primaryKey'>ACTUALACTION_IDX</td>
  <td class='detail'>Primary key</td>
  <td class='detail' style='text-align:left;'><span title='Ascending'>Asc</span></td>
  <td class='constraint' style='text-align:left;'>PK_ACTUALACTION</td>
 </tr>
</table>
</div>
</div>
