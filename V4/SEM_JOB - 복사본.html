...
<head>
  <!-- SchemaSpy rev 590 -->
  <title>SchemaSpy - Table sem5.dbo.SEM_JOB</title>
...
<table width='100%' border='0' cellpadding='0'>
 <tr>
  <td class='heading' valign='middle'><span class='header'>Table <span title='Database'>sem5</span>.<span title='Schema'>dbo</span>.<span title='Table'>SEM_JOB</span></span><div style='padding: 0px 4px;'>Keeps job name for Command process.</div><p>
</td>
...
<tr class='odd'>
 <td class='detail'>COMMAND_NAME</td>
 ...
 <td class='detail'></td>
 <td class='detail'> </td>
 <td class='comment detail'>Hard-coded English string that indicates which command was launched. This is the same string placed in the XML for pre-defined name.<br /><br />Update_Now = Update content.<br />ScanNow_Full = Do a full scan.<br />ScanNow_Quick = Do an Active Scan.<br />ScanNow_Custom = Do a custom scan.<br />Update_ScanNow_Full = Update content and then do a full scan.<br />Update_ScanNow_Quick = Update content and do an Active Scan.<br />Update_ScanNow_Custom = Update content and do a custom scan.<br />CancelScan = Cancel the scan.<br />Reboot = Restart.<br />ApOn = Turn Auto-Protect on.<br />ApOff = Turn Auto-Protect off.<br />FwOn = Turn the firewall on.<br />FwOff = Turn the firewall off.<br />DeleteQuarantine = Delete from Quarantine.</td>
</tr>
<tr class='even'>
 <td class='detail'>COMMAND_DESC</td>
 <td class='detail'>nvarchar</td>
 <td class='detail' align='right'>700</td>
 <td class='detail' align='center' title='nullable'>&nbsp;&radic;&nbsp;</td>
 <td class='detail' align='center'></td>
 <td class='detail' align='right'>null</td>
 <td class='detail'></td>
 <td class='detail'> </td>
 <td class='comment detail'>A detailed description of the command.</td>
</tr>
<tr class='odd'>
 <td class='detail'>SOURCE_SITE_ID</td>
 <td class='detail'>char</td>
 <td class='detail' align='right'>32</td>
 <td class='detail' align='center'></td>
 <td class='detail' align='center'></td>
 ...
 <td class='detail'></td>
 <td class='detail'> </td>
 <td class='comment detail'>The GUID of the site from where the command was generated.</td>
</tr>
<tr class='even'>
 <td class='detail'>SOURCE_ADMIN_ID</td>
 <td class='detail'>char</td>
 <td class='detail' align='right'>32</td>
 <td class='detail' align='center'></td>
 <td class='detail' align='center'></td>
 ...
 <td class='detail'></td>
 <td class='detail'> </td>
 <td class='comment detail'>The GUID of the administrator who issued the command.</td>
</tr>
<tr class='odd'>
 ...
 <td class='detail'></td>
 <td class='detail'> </td>
 <td class='comment detail'>The time at which the command was issued by the administrator at the console.</td>
</tr>
<tr class='even'>
...
<tr class='odd'>
 ...
 <td class='detail'></td>
 <td class='detail'> </td>
 <td class='comment detail'>Deleted row:<br />1 = Deleted<br />0 = Not deleted</td>
</tr>
<tr class='even'>
 <td class='detail'>SOURCE_TYPE</td>
 <td class='detail'>tinyint</td>
 <td class='detail' align='right'>1</td>
 <td class='detail' align='center'></td>
 <td class='detail' align='center'></td>
...
<tr class='odd'>
 <td class='detail'>SOURCE_HOST_IP</td>
 <td class='detail'>varchar</td>
...
<tbody>
 <tr>
  <td class='primaryKey'>COMMAND_ID</td>
  <td class='detail'>Primary key</td>
  <td class='detail' style='text-align:left;'><span title='Ascending'>Asc</span></td>
  <td class='constraint' style='text-align:left;'>PK_SEM_JOB</td>
 </tr>
</table>
</div>
</div>
